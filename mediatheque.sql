...
INSERT INTO Abonne(nom, dateNaiss, banni) VALUES
('Emma', STR_TO_DATE('12-07-2005', '%d-%m-%Y'), '2000-01-01'),
('Noah', STR_TO_DATE('04-02-2000', '%d-%m-%Y'), '2000-01-01'),
('Léa', STR_TO_DATE('23-11-2007', '%d-%m-%Y'), '2000-01-01'),
('Ethan', STR_TO_DATE('8-05-2010', '%d-%m-%Y'), '2000-01-01'),
('Charlotte', STR_TO_DATE('19-09-2002', '%d-%m-%Y'), '2000-01-01');
